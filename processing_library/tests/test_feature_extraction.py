...
import pytest
import pandas as pd
from battery_analysis.feature_extraction import build_ocv_map, assign_cycle_keys, calculate_coulombic_and_energy_eff
...
def test_build_ocv_map():
    ...
    df = pd.DataFrame({
        "discharge_capacity": [0, 0.5, 1.0, 1.5, 2.0],
        "voltage": [4.2, 4.0, 3.8, 3.4, 3.1]
    })
